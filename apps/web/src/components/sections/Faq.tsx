...
const ITEMS: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: 'Не потеряю ли я гарантию на автомобиль?', a: 'На двигатель — нет, если установка сертифицированная и зарегистрирована в ГИБДД. По условиям конкретной марки уточним перед началом работ.' },
  ...
  { q: 'Ставите на Toyota Camry D-4S / VW TSI / Kia GDI?', a: 'Да. На двигатели с прямым или комбинированным впрыском ставим Prins и OMVL. Сначала бесплатная диагностика двигателя — подбираем комплект под конкретную модель и год.' },
  ...
  { q: 'Обязательна ли регистрация в ГИБДД?', a: 'Да. С 2016 года без регистрации ГБО эксплуатация незаконна. Выдаём полный пакет документов и сопровождаем на осмотре.' },
