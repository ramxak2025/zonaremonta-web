...
const ITEMS: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: 'В чём разница между ГБО 4 и 4+?', a: '4-е поколение — для инжекторных моторов с распределённым впрыском. 4+ (Direct Injection) — для прямого впрыска: TSI, FSI, GDI, D-4S. Это принципиально разные системы.' },
